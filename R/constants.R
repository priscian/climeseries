...
data_urls <- c(list(
  ...
  `Antarctica Land Ice Mass Variation` = list(path=nasaLandIceMassBase %_% "antarctica_mass_200204_202103.txt", type="land ice"),
  `Greenland Land Ice Mass Variation` = list(path=nasaLandIceMassBase %_% "greenland_mass_200204_202103.txt", type="land ice"),
  `Ocean Mass Variation` = list(path=nasaOceanMassBase %_% "ocean_mass_200204_202103.txt", type="ocean mass"),
  ## GISTEMP v3
